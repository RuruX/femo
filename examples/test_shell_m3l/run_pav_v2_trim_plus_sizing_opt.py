...
# cruise_condition.set_module_input(name='pitch_angle', val=np.deg2rad(0.50921594), dv_flag=True, lower=np.deg2rad(-10), upper=np.deg2rad(10)) # 1g case
cruise_condition.set_module_input(name='pitch_angle', val=np.deg2rad(6), dv_flag=True, lower=np.deg2rad(-10), upper=np.deg2rad(10)) # 3g case
